...
fun getRandomQuote(): Phrase {
    val quotes = listOf(
        ...
        Phrase(
            quoteEs = "Disciplina en la acción, resiliencia en la adversidad, constancia en el tiempo.",
            quoteEn = "Discipline in action, resilience in adversity, constancy over time."
        ),

        Phrase(
            quoteEs = "No es más fuerte quien nunca cae, sino quien siempre se levanta.",
            quoteEn = "The strongest is not the one who never falls, but the one who always gets up."
        )
